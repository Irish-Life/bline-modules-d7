<?php
  ...
  // COVER
  ?>
  <div class="front-img" style="background:url('<?php echo drupal_get_path('module', 'business_protection_filter');?>/images/personal-shareholder-protection-report-cover.jpg') no-repeat;"><div class="front-author">Prepared for <?php echo $businessName ?></div></div>
  <pagebreak>
  <?
  ///////////////////////
  ///////////////////////
