<?php
  ...
  // COVER
  ?>
  <div class="front-img" style="background:url('<?php echo drupal_get_path('module', 'business_protection_filter');?>/images/personal-shareholder-protection-report.jpg') no-repeat;"><div class="front-author">Prepared for <?php echo $businessName ?></div></div>
  <pagebreak>
  <?
  ///////////////////////
  ///////////////////////
  ...
  <div class="report">
    ...
    <p>Based on the company’s particular circumstances you have chosen to arrange cover on an own life in trust basis.</p>
     <p>Each shareholder who has signed up to the legal agreement takes out a protection plan on their own life for a sum assured equal to the value of their share of the company.</p>
     <p>Each plan is written under trust for the benefit of the other shareholders covered by the agreement.</p>
     <p>Each shareholder pays the premium on his / her own plan.</p>
    ...
    <p>On death the proceeds of the plan are paid to the trustee(s) of the plan for the benefit of the surviving shareholders who are party to the arrangement. Revenue have clarified that the proceeds of such a plan are exempt from Inheritance Tax in the hands of surviving shareholders, where they use the proceeds to purchase the deceased’s share of the company.</p>
