<?php
  ...
  <div class="report">
    ...
    <p>This report is based on the answers provided and the selected route chosen through the Business Protection Pathfinder. It is understood that cover is required by the company for replacement costs.</p>
    ...
    <p>The company takes out a protection plan on <?php echo $keyPersonAName ?> to replace them within the business. The plan is arranged as follows:</p>
    <ul>
...
<pagebreak>
    ...
    <p>In this case the level of cover on the contract is related to the individuals salary. You have chosen that the level of cover is based on <?php echo $keyPersonBShare ?> times the salary of <?php echo $keyPersonAName ?>. 
    ...
    <h5><u>Taxation of Plan Benefits – Loss of Profits (Revenue item)</u></h5>
