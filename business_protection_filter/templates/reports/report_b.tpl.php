<?php
  ...
  <div class="report">
    ...
    <p>Based on the partnerships particular circumstances you have chosen to arrange cover on an own life in trust basis.</p>
      <ul>
        <li>Each partner who has signed up to the legal agreement takes out a protection plan on their own life for a sum assured equal to the value of their share of the partnership.</li>
        <li>Each plan is written under trust for the benefit of the other partners covered by the agreement.</li>
        <li>Each partner pays the premium on his / her own plan.</li>
      </ul>
    ...
    <p>The agreement can be framed as a Double Option agreement that provides in the event of the death of a partner to allow:</p>
    ...
    <p>On death the proceeds of the plan are paid to the trustee(s) of the plan for the benefit of the surviving partners who are party to the arrangement. Revenue have clarified that the proceeds of such a plan are exempt from Inheritance Tax in the hands of surviving partners, where they use the proceeds to purchase the deceased’s share of the business.</p>
